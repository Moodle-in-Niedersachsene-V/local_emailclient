...
// Kontakte / Adressbuch.
$string['page:contacts'] = 'Kontakte';
$string['contact:firstname'] = 'Vorname';
$string['contact:lastname'] = 'Nachname';
$string['contact:email'] = 'E-Mail-Adresse';
$string['contact:phone'] = 'Telefon';
$string['contact:organisation'] = 'Organisation';
$string['contact:notes'] = 'Notizen';
$string['contact:shared'] = 'Für alle sichtbar (geteilter Kontakt)';
$string['contact:shared_help'] = 'Geteilte Kontakte sind für alle Nutzer/innen mit Zugang zum E-Mail-Client sichtbar. Nur Sie können diesen Kontakt bearbeiten oder löschen.';
$string['contact:save'] = 'Kontakt speichern';
$string['contact:saved'] = 'Kontakt gespeichert.';
$string['contact:deleted'] = 'Kontakt gelöscht.';
$string['contact:deleteconfirm'] = 'Diesen Kontakt wirklich löschen?';
$string['contact:add'] = 'Kontakt hinzufügen';
$string['contact:edit'] = 'Kontakt bearbeiten';
$string['contact:empty'] = 'Noch keine Kontakte vorhanden.';
$string['contact:personal'] = 'Meine Kontakte';
$string['contact:name'] = 'Name';
$string['contact:compose'] = 'Mail schreiben';
$string['contact:picker'] = '📋 Aus Kontakten';
$string['contact:search'] = 'Kontakt suchen…';
$string['settings:contactsheading'] = 'Adressbuch';
$string['settings:contactsheading_desc'] = 'Einstellungen für das Adressbuch und geteilte Kontakte.';
$string['settings:allowsharedcontacts'] = 'Geteilte Kontakte aktivieren';
$string['settings:allowsharedcontacts_desc'] = 'Wenn aktiviert, können Nutzer/innen Kontakte als „für alle sichtbar" markieren. Geteilte Kontakte erscheinen im Adressbuch aller Nutzer/innen mit Zugang zum E-Mail-Client.';
